...
gulp.task('devmanifest', () => gulp.src('app/manifest.json').pipe(gulp.dest('dist')));
...
gulp.task('devbuild', callback => runSequence('clean:dist', ['jsprep', 'cssprep', 'views', 'swjs', 'devindex', 'devmanifest'], callback));
